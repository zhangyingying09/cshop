...
<div>
        <div class="g-pay-lst">
            ...
            <p class="gray9">总需支付金额：<em class=""><i>￥</i>{{$buy_number}}</em></p>
        </div>
        ...
        <div class="g-Total-bt">
            <dd><a id="btnPay" href="{{url('alipay/mobilepay')}}" class="orangeBtn fr w_account">立即支付</a></dd>
        </div> 
        ...
        <div class="paywrapp" style="display: none">
            ...
            <div class="submit">
                ...
                <input type="submit" value="确ll定" class="button" id="subbtn">
            </div>
        </div>
